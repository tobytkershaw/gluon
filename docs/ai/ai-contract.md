...
Fields:
- **tracks[]** — each track's current state (1–16 tracks, variable), with a human-readable `label` (e.g. "Track 1 (Kick)"), parameters (semantic names), agency, pattern, views, processor chain, modulators, and modulation routings
