...
const AI_ONLY_TOOLS = new Set([
  ...
  'inspect_chain',      // AI-generated chain description / simplification suggestions
...
const PARITY_GAP_TOOLS = new Set([
  ...
  'relate',                    // LOW: compound tool — humans can manually implement the resulting cross-track edits
  ...
  'set_chord_progression', // MODERATE: no UI for chord progression (metadata for AI harmonic guidance)
  ...
  'save_memory',         // AI-ONLY: AI saves persistent project memories — human can view/delete via future UI
]);
...
describe('Human Capability Parity', () => {
  ...
  it('documents the expected number of parity gaps', () => {
    ...
    expect(PARITY_GAP_TOOLS.size).toBe(25);
  });
