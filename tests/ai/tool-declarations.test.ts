...
describe('Tool Declarations', () => {
  it('exports eight tool declarations', () => {
    expect(GLUON_TOOLS).toHaveLength(8);
  });

  it('declares move, sketch, listen, set_transport, set_model, transform, add_view, remove_view', () => {
