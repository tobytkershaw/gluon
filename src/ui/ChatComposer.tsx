  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="shrink-0 rounded-full flex items-center justify-center transition-colors w-6 h-6 text-amber-400/70 disabled:text-zinc-800 hover:text-amber-300"
      >
